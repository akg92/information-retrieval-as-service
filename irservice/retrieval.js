...
class Retriver {
    ...
    */
    ...
    async insert_document(main_index, secondary_index, file_name,file_id, user_info) {
            ...
            client.search(elastic_query, (err, result) => {
                if (err) {
                    ...
                    if (result.body.hits.hits) {
                        return resolve(result.body.hits.hits);
                    }
                    else {
...
var test = async () => {
    ...
    await ret_class.insert_document(primary_index, secondary_index, file_name,file_name);
    let result_promise = await ret_class.search_document(query);
    //result_promise.then((data) => { console.log(data) });
